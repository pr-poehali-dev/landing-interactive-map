          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {ADVANTAGES.map((a, i) => {
              ...
              return (
                <div
                  key={a.title}
                  className="group rounded-2xl overflow-hidden border border-gray-100 hover:shadow-xl transition-all animate-fade-up flex flex-col"
            ...
            {PLANS_PREVIEW.map((plan, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* BOTTOM: Colored light footer */}
                  <div className={`${theme.light} px-8 py-5 border-t border-gray-100`}>
                    <Link
                      to="/tariffs"
            ...
            <div className="space-y-3">
              {SERVERS_PREVIEW.map((s, i) => {
                ...
                return (
                  <div
                    key={s.city}
                    className={`relative rounded-xl overflow-hidden border border-gray-100 hover:shadow-md transition-all animate-fade-up border-l-4 ${lc.border}`}
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={f.title}
                    className="flex gap-4 p-4 rounded-xl bg-white border border-gray-100 hover:shadow-md transition-all animate-fade-up"
                    style={{ opacity: 0, animationDelay: `${i * 0.1}s` }}
                  >
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-4 max-w-3xl mx-auto">
            {PARTNERS.map((p, i) => {
              ...
              return (
                <div
                  key={p.label}
                  className="group flex flex-col items-center gap-3 pt-0 pb-6 px-4 bg-white border border-gray-100 rounded-xl overflow-hidden hover:shadow-lg hover:border-gray-200 transition-all animate-fade-up"
                  style={{ opacity: 0, animationDelay: `${i * 0.06}s` }}
                >
                  {/* Top gradient stripe */}
