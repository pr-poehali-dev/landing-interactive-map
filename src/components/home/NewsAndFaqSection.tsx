    ...
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {NEWS.map((n, i) => (
              <Link
                key={n.title}
                to="/blog"
                className="bg-white border border-gray-200 rounded-2xl p-7 hover:shadow-lg hover:border-v-100 transition-all animate-fade-up"
      ...
      <section className="py-24 px-5">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl px-7">
            {FAQ_ITEMS.map((f) => (
